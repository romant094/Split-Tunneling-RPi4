...
- [x] 16-07-PLAN.md — Logs.jsx UX: dedupe toggle, hover highlight, right-click context menu, multi-select batch-add, human timestamps, ✓/✗ legend [UI-LOGS] (depends 16-05)
